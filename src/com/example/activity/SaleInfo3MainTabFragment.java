...
public class SaleInfo3MainTabFragment extends Fragment
{
	private EditText saleInfo3_editText_goodsname;//商品名称
	private EditText saleInfo3_editText_price;//商品价格
	private EditText saleInfo3_editText_place;//商品地点
	private EditText saleInfo3_editText_describe;//商品描述
	private Button saleInfo3_button_ensure;
	
	private ImageView saleInfo3_imageView_goods1;//商品图片1
	private ImageView saleInfo3_imageView_goods2;//商品图片2
	private ImageView saleInfo3_imageView_goods3;//商品图片3
	private ImageView saleInfo3_imageView_goods4;//商品图片4
	private ImageView saleInfo3_imageView_goods5;//商品图片5
	private ImageView saleInfo3_imageView_goods6;//商品图片6
	...
	public static SaleInfo3MainTabFragment saleInfo3MainTabFragment;
	
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState){
		view  =  inflater.inflate(R.layout.create_sale_info3, container, false);
		saleInfo3MainTabFragment = this;
	...
	private void imageDisplay(int size) {
		...
		switch(size){
			case 1:
				saleInfo3_imageView_goods3.setVisibility(View.GONE);
			case 2:
				saleInfo3_imageView_goods4.setVisibility(View.GONE);
			case 3:
				saleInfo3_imageView_goods5.setVisibility(View.GONE);
			case 4:
				saleInfo3_imageView_goods6.setVisibility(View.GONE);
				break;
		}
	}
	private void setImageToView(String s,int i) {
		...
		if(i==1){
			saleInfo3_imageView_goods2.setImageBitmap(pic);
			saleInfo3_imageView_goods2.setVisibility(View.VISIBLE);
		}
		if(i==2){	
			saleInfo3_imageView_goods3.setImageBitmap(pic);
			saleInfo3_imageView_goods3.setVisibility(View.VISIBLE);	
		}
		if(i==3){
			saleInfo3_imageView_goods4.setImageBitmap(pic);
			saleInfo3_imageView_goods4.setVisibility(View.VISIBLE);	
		}
		if(i==4){
			saleInfo3_imageView_goods5.setImageBitmap(pic);
			saleInfo3_imageView_goods5.setVisibility(View.VISIBLE);
		}
		if(i==5){
			saleInfo3_imageView_goods6.setImageBitmap(pic);
			saleInfo3_imageView_goods6.setVisibility(View.VISIBLE);
		}
	}
	
	private void initEvent() {
		// TODO 自动生成的方法存根
	 saleInfo3_imageView_goods1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra("contextActivity", "saleInfo3");
				startActivityForResult(intent, 1);//requestCode = 1
			}
		});
		saleInfo3_button_ensure.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO 自动生成的方法存根
				goodsname = saleInfo3_editText_goodsname.getText().toString();
				price = saleInfo3_editText_price.getText().toString();
				place = saleInfo3_editText_place.getText().toString();
				describe = saleInfo3_editText_describe.getText().toString();
	...
	private void initView() {
		...
		saleInfo3_editText_price = (EditText) view.findViewById(R.id.saleInfo3_editText_price);
		saleInfo3_editText_place = (EditText) view.findViewById(R.id.saleInfo3_editText_place);
		saleInfo3_editText_describe = (EditText) view.findViewById(R.id.saleInfo3_editText_describe);
		
		saleInfo3_imageView_goods1 = (ImageView) view.findViewById(R.id.saleInfo3_imageView_goods1);
		saleInfo3_imageView_goods2 = (ImageView) view.findViewById(R.id.saleInfo3_imageView_goods2);
		saleInfo3_imageView_goods3 = (ImageView) view.findViewById(R.id.saleInfo3_imageView_goods3);
		saleInfo3_imageView_goods4 = (ImageView) view.findViewById(R.id.saleInfo3_imageView_goods4);
		saleInfo3_imageView_goods5 = (ImageView) view.findViewById(R.id.saleInfo3_imageView_goods5);
		saleInfo3_imageView_goods6 = (ImageView) view.findViewById(R.id.saleInfo3_imageView_goods6);
		
		saleInfo3_button_ensure = (Button) view.findViewById(R.id.saleInfo3_button_ensure);
	}
